...
class Ability
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=UnitAbility::class, mappedBy="ability_id")
     */
    ...
    public function removeUnitAbility(UnitAbility $unitAbility): self
    {
        if ($this->unitAbilities->removeElement($unitAbility)) {
            ...
            if ($unitAbility->getAbilityId() === $this) {
                $unitAbility->setAbilityId(null);
            }
        }
